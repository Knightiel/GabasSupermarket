...
public class Admin extends javax.swing.JFrame {
    ...
    public boolean validaUsuario(){
        ...
        if(bd.getConnection()){
            try{
                String query = "SELECT * FROM users WHERE nome_user = ? AND senha_user = ? AND eh_admin = 1";
                PreparedStatement smtp = bd.conexao.prepareStatement(query);
                smtp.setString(1,a.getUsuario());
                smtp.setString(2,a.getSenha());
